...
| `elissa-impl`           | Native | ✅      | `Foo::<T>`      | ❌                    | `T: I`                           | ✅             |

## Declaration sites

| Feature                                     | phpdoc | reified | holly      | elissa                      |
| ------------------------------------------- | ------ | ------- | ---------- | --------------------------- |
...
| Generic trait                               | doc    | ✅      | ❌         | ❌ ( does not have traits ) |
...
| `instanceof` an instantiation                 | n/a    | ✅      | ✅    | ❌ ( has `is` operator )       |
| Variadic value parameter `T ...$xs`           | doc    | ✅      | ✅    | ❌ ( does not have variadics ) |
| `T::class`                                    | ❌     | ❌      | ✅    | ❌ ( use `type_name!(T)` )     |
